...
import definition.ExplosionUtils;


import particle.ExplodeParticle;
...
public class ExplodeParticleFactory extends ParticleFactory{
    ...
    public static final float X = ExplosionUtils.dp2Px(5);
    public static final float Y = ExplosionUtils.dp2Px(20);
    public static final float V = ExplosionUtils.dp2Px(2);
    public static final float W = ExplosionUtils.dp2Px(1);
